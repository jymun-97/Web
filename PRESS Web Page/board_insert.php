...
<?php
	...
	$sql = "insert into board (email, name, subject, content, regist_day, hit, ncomment, likes, fix, file_name, file_type, file_copied) ";
	$sql .= "values('$useremail', '$username', '$subject', '$content', '$regist_day', 0, 0, 0, 0, ";
