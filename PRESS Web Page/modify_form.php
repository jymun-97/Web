...
<body> 
	...
	<div id="join_box">
		<form name="join_form" method="post" action="modify.php">
			...
			<p><input type="text" value="<?=$username?>" placeholder="Name" name= "name" style="width: 300px; height: 30px;" disabled></p>
			<p><input type="text" value="<?=$studentID?>" placeholder="Student ID" name= "studentID" style="width: 300px; height: 30px;"></p>
			<p><input type="text" value="<?=$useremail?>" placeholder="email" name= "email" style="width: 300px; height: 30px;"></p>
			<p><input placeholder="password" name= "pass" style="width: 300px; height: 30px;"></p>
			<p><input placeholder="password confirm" name= "pass_confirm" style="width: 300px; height: 30px;"></p>
			<p>
			...
			<p><input type="button" style="width: 300px; height: 40px; color: white; background-color: rgb(25, 64, 86); cursor: pointer;" onclick="check_input()" value="수정하기"></p>
		</form>
	</div>
</body>
</html>
